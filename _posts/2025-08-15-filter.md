...
As a side effect of my strategies, the filter very is Latin-focused and would not work well for a language like Chinese, where the words aren't space-delimited and [homophonic puns](https://en.wikipedia.org/wiki/Homophonic_puns_in_Standard_Chinese) are a more popular attack
